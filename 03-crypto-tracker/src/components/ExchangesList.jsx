                          ...
                          <article key={index} className='exchange'>
                              ...
                              <div className='exchange-data-container'>
                                  <div className='exchange-data'>
                                      ...
                                      <p className='exchange-data-value'>{exchange.trust_score_rank}</p>
                                  </div>
                                  <div className='exchange-data'>
                                      <p className='exchange-data-title'>Trade Volume 24h</p>
                                      <p className='exchange-data-value'>{exchange.trade_volume_24h_btc.toFixed(2) + ' BTC'}</p>
                                  </div>
                                  <div className='exchange-data'>
                                      <p className='exchange-data-title'>Trust Score</p>
                                      <p className='exchange-data-value'>{exchange.trust_score}</p>
                                  </div>
                                  <div className='exchange-data'>
                                      <p className='exchange-data-title'>Country</p>
                                      <p className='exchange-data-value'>{exchange.country}</p>
                                  </div>
                                  <div className='exchange-data'>
                                      <p className='exchange-data-title'>Year Established</p>
                                      <p className='exchange-data-value'>{exchange.year_established}</p>
                                  </div>
                                  <div className='exchange-data'>
                                      <p className='exchange-data-title'>Website</p>
                                      <p className='exchange-data-value'>{exchange.url}</p>
                                  </div>
                              </div>
                          </article>
                      );
