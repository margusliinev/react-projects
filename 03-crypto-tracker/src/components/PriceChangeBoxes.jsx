        ...
        <div className='price-change-boxes'>
            <div className='price-change-box'>
                ...
                <div className={coin && coin.market_data && coin.market_data.price_change_percentage_1h_in_currency.eur > 0 ? 'coins-box-change-value bright-box-green value-green' : 'coins-box-change-value bright-box-red value-red'}>
                    ...
                    <p className={coin && coin.market_data && coin.market_data.price_change_percentage_1h_in_currency.eur > 0 ? 'value-green' : 'value-red'}>{coin ? Math.abs(coin && coin.market_data && coin.market_data.price_change_percentage_1h_in_currency.eur.toFixed(2)) + '%' : 0 + '%'}</p>
                </div>
            </div>
            <div className='price-change-box'>
                ...
                <div className={coin && coin.market_data && coin.market_data.price_change_percentage_24h_in_currency.eur > 0 ? 'coins-box-change-value bright-box-green value-green' : 'coins-box-change-value bright-box-red value-red'}>
                    ...
                    <p className={coin && coin.market_data && coin.market_data.price_change_percentage_24h_in_currency.eur > 0 ? 'value-green' : 'value-red'}>{coin ? Math.abs(coin && coin.market_data && coin.market_data.price_change_percentage_24h_in_currency.eur.toFixed(2)) + '%' : 0 + '%'}</p>
                </div>
            </div>
            <div className='price-change-box'>
                ...
                <div className={coin && coin.market_data && coin.market_data.price_change_percentage_7d_in_currency.eur > 0 ? 'coins-box-change-value bright-box-green value-green' : 'coins-box-change-value bright-box-red value-red'}>
                    ...
                    <p className={coin && coin.market_data && coin.market_data.price_change_percentage_7d_in_currency.eur > 0 ? 'value-green' : 'value-red'}>{coin ? Math.abs(coin && coin.market_data && coin.market_data.price_change_percentage_7d_in_currency.eur.toFixed(2)) + '%' : 0 + '%'}</p>
                </div>
            </div>
            <div className='price-change-box'>
                ...
                <div className={coin && coin.market_data && coin.market_data.price_change_percentage_14d_in_currency.eur > 0 ? 'coins-box-change-value bright-box-green value-green' : 'coins-box-change-value bright-box-red value-red'}>
                    ...
                    <p className={coin && coin.market_data && coin.market_data.price_change_percentage_14d_in_currency.eur > 0 ? 'value-green' : 'value-red'}>{coin ? Math.abs(coin && coin.market_data && coin.market_data.price_change_percentage_14d_in_currency.eur.toFixed(2)) + '%' : 0 + '%'}</p>
                </div>
            </div>
            <div className='price-change-box'>
                ...
                <div className={coin && coin.market_data && coin.market_data.price_change_percentage_30d_in_currency.eur > 0 ? 'coins-box-change-value bright-box-green value-green' : 'coins-box-change-value bright-box-red value-red'}>
                    ...
                    <p className={coin && coin.market_data && coin.market_data.price_change_percentage_30d_in_currency.eur > 0 ? 'value-green' : 'value-red'}>{coin ? Math.abs(coin && coin.market_data && coin.market_data.price_change_percentage_30d_in_currency.eur.toFixed(2)) + '%' : 0 + '%'}</p>
                </div>
            </div>
            <div className='price-change-box'>
                ...
                <div className={coin && coin.market_data && coin.market_data.price_change_percentage_1y_in_currency.eur > 0 ? 'coins-box-change-value bright-box-green value-green' : 'coins-box-change-value bright-box-red value-red'}>
                    ...
                    <p className={coin && coin.market_data && coin.market_data.price_change_percentage_1y_in_currency.eur > 0 ? 'value-green' : 'value-red'}>{coin ? Math.abs(coin && coin.market_data && coin.market_data.price_change_percentage_1y_in_currency.eur.toFixed(2)) + '%' : 0 + '%'}</p>
                </div>
            </div>
        </div>
    );
